...
const translations = {
  ...
  ar: {
    ...
    'login.recoveryTitle': 'بروتوكول استعادة الوصول',
    'login.recoverySubtitle': 'اختر طريقة استعادة الوصول لهذا الحساب المؤسسي.',
    'login.recoveryClose': 'إغلاق',
    'login.recoveryEmailTitle': 'رابط إعادة التعيين عبر البريد',
    ...
    'login.recoverySecurityTitle': 'التحقق الأمني',
    'login.recoverySecurityDescription': 'استخدام التحقق الداخلي من الهوية قبل إعادة تعيين كلمة المرور.',
    'login.recoveryGenerating': 'جاري إنشاء الاستعادة...',
