...
const DEFINITIONS: Record<string, AuditDefinition> = {
  ...
  'qr.token_issued': { canonicalAction: 'qr.token_issued', module: 'qr', summary: 'QR token issued', metadataKeys: ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'] },
  'qr.token_rotated': { canonicalAction: 'qr.token_rotated', module: 'qr', summary: 'QR token rotated', metadataKeys: ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'] },
  'qr.token_revoked': { canonicalAction: 'qr.token_revoked', module: 'qr', summary: 'QR token revoked', metadataKeys: ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'] },
  'qr.token_consumed': { canonicalAction: 'qr.token_consumed', module: 'qr', summary: 'QR token consumed', metadataKeys: ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'] },
  'qr.token_expired': { canonicalAction: 'qr.token_expired', module: 'qr', summary: 'QR token expired', metadataKeys: ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'] },
...
const WRITE_METADATA_ALLOWLIST: Record<string, readonly string[]> = {
  ...
  'qr.token_issued': ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'],
  'qr.token_rotated': ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'],
  'qr.token_revoked': ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'],
  'qr.token_consumed': ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'],
  'qr.token_expired': ['tokenRecordId', 'purpose', 'subjectType', 'issuerEmployeeId', 'status', 'expiresAt', 'singleUse'],
