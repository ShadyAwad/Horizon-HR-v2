...
CREATE TABLE IF NOT EXISTS performance_review_questions (
  ...
  CONSTRAINT performance_review_questions_tenant_unique UNIQUE (id, tenant_id),
...
CREATE TABLE IF NOT EXISTS performance_reviews (
  ...
  CONSTRAINT performance_reviews_tenant_unique UNIQUE (id, tenant_id),
...
CREATE TABLE IF NOT EXISTS performance_review_assignments (
  ...
  CONSTRAINT performance_assignments_tenant_unique UNIQUE (id, tenant_id),
...
CREATE TABLE IF NOT EXISTS performance_goals (
  ...
  CONSTRAINT performance_goals_tenant_unique UNIQUE (id, tenant_id),
...
CREATE TABLE IF NOT EXISTS employee_recognitions (
  ...
  CONSTRAINT employee_recognitions_tenant_unique UNIQUE (id, tenant_id),
